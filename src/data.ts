...
export const demoPartners: Partner[] = [
  {
    ...
    therapies: ['Trauma', 'Dual diagnosis', 'Eating disorders', 'Chronic relapse', 'EMDR', 'IFS', 'Family systems'],
  ...
  },
  {
    ...
    therapies: ['Trauma', 'Dual diagnosis', 'Chronic relapse', 'MAT', 'Equine', 'Adventure', 'CBT'],
  ...
  },
  {
    ...
    therapies: ['Trauma', 'Dual diagnosis', 'Adolescent', 'LGBTQ+', 'Gambling', 'DBT', 'EMDR', 'Family systems'],
  ...
  },
  {
    ...
    cashMax: 28000,
    insurance: ['Cash pay'],
    therapies: ['Family systems', 'Dual diagnosis', 'Gambling', 'Sex addiction', 'Chronic pain'],
  ...
  },
  {
    ...
    therapies: ['Trauma', 'Eating disorders', 'LGBTQ+', 'EMDR', 'IFS', 'Family systems'],
  ...
  },
  {
    ...
    cashMax: 6500,
    insurance: ['Cash pay'],
    therapies: ['Adventure', 'Faith based', 'Chronic relapse', 'Family systems'],
  ...
  },
  {
    ...
    therapies: ['Trauma', 'Dual diagnosis', 'Chronic relapse', 'MAT', 'Equine', 'EMDR', 'DBT', 'Adventure'],
  ...
  },
  {
    ...
    therapies: ['Dual diagnosis', 'Trauma', 'Chronic relapse', 'MAT'],
    populations: ['Adults'],
